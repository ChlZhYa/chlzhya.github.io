    ...
    },
    {
      ...
      events: [
        ...
        },
        {
          ...
          type: '景点',
          title: '三清山大环线徒步',
          description: '从外双溪出发，完整大环线：南清园（巨蟒出山、东方女神、玉台、一线天）→ 阳光海岸 → 三清宫 → 玉京峰 → 西海岸栈道 → 返回外双溪。',
          icon: 'hiking',
          color: 'secondary',
          detail: `完整大环线约15km，7-8小时（含休整）。路线：外双溪→南清园→阳光海岸→三清宫→玉京峰→西海岸→返回。

🕘 09:00 外双溪出发
🕙 09:00–10:00 → 登山至南清园入口（约1h，连续爬升）
🕚 10:00–11:30 → 🏔️ 南清园景区：巨蟒出山→东方女神→玉台→杜鹃谷→一线天（约1.5h，山脊平路+少量台阶）
🕛 11:30–12:00 → 阳光海岸栈道（约30min，平缓悬崖栈道）
🕐 12:00–12:30 → 三清宫休整、午餐
🕜 12:30–14:00 → ⛰️ 攀登玉京峰（约1.5h，海拔1819m，全程最陡）
🕑 14:00–14:30 → 峰顶停留、拍照
🕝 14:30–16:00 → 🌅 西海岸栈道返回（约1.5h，悬崖栈道，风景最佳）
🕟 16:00–16:30 → 下山至外双溪，取行李

⚠️ 若 14:00 未登顶玉京峰，跳过峰顶直接走西海岸下山。
🍞 自备路餐和 2L 饮水，西海岸和阳光海岸有小卖部但价格较高。`,
        },
        {
          time: '下午 17:00',
          type: '交通',
    ...
    },
    {
      ...
      events: [
        ...
        },
        {
          ...
          icon: 'landscape',
          color: 'primary',
          detail: `后山上、前山下的经典路线。按路段自查：

🕣 08:30 云谷索道上（约10min）
🕘 08:45–09:05 → 云谷上站→猴子观海（约20min）
🕤 09:05–09:15 → 猴子观海停留拍照
🕘 09:15–09:40 → 猴子观海→排云亭（约25min）
🕤 09:40–10:40 → 排云亭→一环→二环→谷底（约1h，连续下坡台阶）
🕥 10:40–12:10 → 谷底→步仙桥→天海（约1.5h，全程最陡爬升⚠️）
🕛 12:10–12:40 → 天海午餐休整
🕐 12:40–13:40 → 天海→鳌鱼峰→玉屏楼（约1h）
🕑 13:40–14:00 → 迎客松打卡、休整
🚡 14:00 玉屏索道下山（末班约17:00–17:30）

⚠️ 若 14:30 仍未到玉屏楼，请加速或放弃部分停留。
💧 西海大峡谷全程无补给点，务必在天海前备足饮水。`,
        },
        {
          time: '下午 13:30',
          type: '景点',
          ...
          icon: 'cable_car',
          color: 'tertiary',
          detail: '天海到玉屏楼约1h，途经鳌鱼峰（黄山36小峰之一）。玉屏楼以迎客松闻名于世。玉屏索道末班约17:00–17:30，务必14:30前到索道口。',
        },
      ],
    },
    {
      ...
      events: [
        ...
        },
        {
          ...
          icon: 'hiking',
          color: 'secondary',
          detail: `天都峰（海拔1810m）与莲花峰轮换开放，2026年为天都峰开放年。按路段自查：

🕗 08:00 慈光阁出发
🕣 08:00–08:30 → 慈光阁→新道口入口（约30min，缓坡热身）
🕘 08:30–10:00 → 新道口→鲫鱼背→天都峰顶（约1.5h，极陡，需手脚并用）
🕙 10:00–10:15 → 峰顶停留拍照
🕥 10:15–11:15 → 老道口下山（约1h，比新道口缓和）

⚠️ 鲫鱼背宽仅1米，两侧万丈深渊，有铁链护栏。旺季新道口可能排队30min–1h，尽量8:00前到入口。
🎯 若 10:30 未登顶，后续行程需压缩停留时间。`,
        },
        {
          time: '上午 10:30',
          type: '景点',
          ...
          icon: 'landscape',
          color: 'primary',
          detail: `🕚 11:15–12:45 → 老道口→光明顶（约1.5h，海拔1860m）
🕛 12:45–13:00 → 光明顶停留（360°全景，远眺莲花峰）
🕐 13:00–13:25 → 光明顶→排云亭（约25min）
🕜 13:25–13:50 → 排云亭→猴子观海（约25min）

光明顶是前山后山分界点。排云亭上午赏西海群峰层次感极佳。`,
        },
        {
          time: '下午 13:00',
          type: '景点',
          ...
          icon: 'cable_car',
          color: 'tertiary',
          detail: `🕑 13:50–14:10 → 猴子观海→始信峰（约20min）
🕝 14:10–14:25 → 始信峰停留（海拔1683m，黄山松最集中区域）
🕝 14:25–14:45 → 始信峰→云谷索道上站（约20min）
🚡 14:45 云谷索道下山（约10min）

🎯 若 15:00 未到云谷索道口，今天赶 G697 会变紧。下山后回酒店冲澡（45min），16:00 前离开酒店赶黄山北站。`,
        },
        {
          time: '下午 16:45',
          type: '交通',
